...
namespace DailyMenuApp
{
    public partial class ProductsForm : Form
    {
        ...
        public ProductsForm()
        {
            ...
            Button btnAutoFillPrices = new Button { Text = "Автозаполнить цены", Dock = DockStyle.Top };

            btnImportJson.Click += BtnImportJson_Click;
            btnExportJson.Click += BtnExportJson_Click;
            btnAutoFillPrices.Click += BtnAutoFillPrices_Click;

            Controls.Add(btnAutoFillPrices);
        ...
        private void BtnAutoFillPrices_Click(object sender, EventArgs e)
        {
            using (OpenFileDialog ofd = new OpenFileDialog())
            {
                ...
                {
                    LoadAveragePrices(ofd.FileName);
                    AutoFillPrices();
                    MessageBox.Show("Цены успешно проставлены!");
                }
            }
        }

        private void AutoFillPrices()
        {
